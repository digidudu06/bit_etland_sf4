...
/*				+'          <p><i class="fa fa-envelope fa-fw w3-margin-right w3-large w3-text-teal"></i>'+x.city+'</p>'
			...
			return '<div class="col-md-8 order-md-1">'
              ...
              +'</div>'
	            ...
	            +'<div class="d-block my-3">'
	              ...
	              +'  <input id="credit" name="color" type="radio" class="custom-control-input" value="white" checked="" required="">'
	                +'<label class="radi custom-control-label" for="credit">화이트</label>'
	              +'</div>'
	              +'<div class="custom-control custom-radio">'
	                +'<input id="debit" name="color" type="radio" class="custom-control-input" value="black" required="">'
	                +'<label class="radi custom-control-label" for="debit">블랙</label>'
	              +'</div>'
	              +'<div class="custom-control custom-radio">'
	                +'<input id="paypal" name="color" type="radio" class="custom-control-input" value="blue" required="">'
		...
		grid : ()=>{
			return '<div id="grid_content2" class="container">'
			  +'<div id="grid_row" class="row">'
				+'<div class="col-md-4">'
					+'<div class="thumbnail">'
