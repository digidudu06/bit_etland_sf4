		...
		prod_regi : ()=>{
			return '<div class="col-md-8 order-md-1">'
	          ...
	          +'<form class="needs-validation" novalidate="">'
	            ...
	            +'<div class="custom-control custom-checkbox">'
	            +'<input type="checkbox" class="custom-control-input" id="same-address">'
	            +'<label class="custom-control-label" for="same-address">이어폰</label>'
	            +'</div>'
	            ...
	            +'<div class="row">'  
	              +'<div class="col-md-6 mb-3">'
	                +'<label for="cc-number">이미지 등록(파일업로드)</label>'
	                +'<input type="file" class="form-control" id="cc-number" placeholder="" required="">'
	              +'</div>'
	            +'</div>'
	            +'<div class="row">'
	              +'<div class="col-md-6 mb-3">'
	                +'<label for="cc-expiration">이미지 등록(드래그 & 드랍)</label>'
